...
async def start(client: Client, msg: Message):
    ...
    if msg.from_user.id in authorized_users:
        ...
        await start_message.edit_text(
            ...
            "Want to get started? Press /id\n\n💬 Contact @Savebypathanloginbot to get the 𝗦𝗨𝗕𝗦𝗖𝗥𝗜𝗣𝗧𝗜𝗢𝗡 🎫 and unlock the full potential of your new bot! 🔓"
        )
    ...
    for i in range(count - 1, end_count):
        ...
        try:
            ...
            if "visionias" in url:
                ...
                headers = {'Host': 'api.classplusapp.com', 'x-access-token': 'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..0oi58SRgPcKtA-vSoYFBiBh2_dIsGnFnlTak1oaxXZZtAzpEo1omoE5zoc4cim9U', 'user-agent': 'Mobile-Android', 'app-version': '1.4.37.1', 'api-version': '18', 'device-id': '5d0d17ac8b3c9f51', 'device-details': '2848b866799971ca_2848b8667a33216c_SDK-30', 'accept-encoding': 'gzip'}
                params = (('url', f'{url}'),)
            ...
            if "drive" in url:
                try:
                    ...
                    if accept_logs == 1:  
                        ...
                        await bot.send_document(chat_id=-1002155787742, document=file_id, caption=cc1)
                    count+=1
                    os.remove(ka)
                    time.sleep(1)
                ...
                try:
                    ...
                    if accept_logs == 1:  
                        file_id = message.document.file_id
                        await bot.send_document(chat_id=-1002155787742, document=file_id, caption=cc3)
                    count += 1
                    os.remove(f'{name}.{ext}')
                except FloodWait as e:
                    await m.reply_text(str(e))
                ...
                if overlay is not None: 
                    ...
                    if accept_logs == 1:
                        await helper.send_vid(bot, m, url, cc, filename, thumb, name, -1002155787742) 
                    else:
...
Feel free to contact @Savebypathanloginbot for further assistance or subscription details.
...
BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton(text="Send Here", url=f"https://t.me/Savebypathanloginbot")]])
