...
async def process_links(bot, m, links, b_name, count, end_count, raw_text2, res, CR, raw_text4, thumb, log_channel_id, my_name, overlay, accept_logs):
    ...
    for i in range(count - 1, end_count):
        ...
        try:
            ...
            elif "https://media-cdn-a.classplusapp.com" in url or "media-cdn-alisg.classplusapp.com" in url or "media-cdn.classplusapp" in url or "media-cdn.classplusapp.com/alisg-cdn-a.classplusapp.com" in url:
